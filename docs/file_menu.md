[${Home page}](https://github.com/peter88213/novelibre) > [${Online help}](index.md) > ${File} menu
...
With **File > Lock** or `Ctrl`-`L`, you can
[lock](basic_concepts.html#project-lock) the project.
...
With **File > Discard manuscript**, you can add the *.bak* extension to
the current manuscript. This may
help to avoid confusion about changes made with *novelibre* and
*Writer*.
